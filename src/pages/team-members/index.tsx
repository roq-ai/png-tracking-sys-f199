...
export function TeamMemberListPage(props: TeamMemberListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTeamMembers({
        ...
        order: params.order,
        searchTermKeys: ['status.contains', 'task_assigned.contains', 'task_completed.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'task_assigned', header: 'Task Assigned', accessorKey: 'task_assigned' },
    { id: 'task_completed', header: 'Task Completed', accessorKey: 'task_completed' },
