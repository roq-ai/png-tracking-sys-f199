  ...
  const fetcher = useCallback(
    async () =>
      getGuests({
        ...
        order: params.order,
        searchTermKeys: ['status.contains', 'organization_viewed.contains', 'feedback_given.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.visited_date ? format(parseISO(record?.visited_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'status', header: 'Status', accessorKey: 'status' },
    { id: 'organization_viewed', header: 'Organization Viewed', accessorKey: 'organization_viewed' },
    { id: 'feedback_given', header: 'Feedback Given', accessorKey: 'feedback_given' },
