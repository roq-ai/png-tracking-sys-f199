...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`PNG tracking system `}</title>

        <meta
          name="description"
          content="is your go-to platform for seamless tracking solutions, ensuring efficiency and accuracy at every step."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1605810230434-7631ac76ec81?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0cmFja2luZyUyMHN5c3RlbXxlbnwwfHx8fDE2OTI2MDgwNjh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`is your go-to platform for seamless tracking solutions, ensuring efficiency and accuracy at every step.`}
            </Text>
            <Box
