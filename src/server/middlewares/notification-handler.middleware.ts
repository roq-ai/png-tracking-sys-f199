...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'team_member.update': {
    ...
    key: 'team-member-profile-update',
    tenantPath: ['organization', 'user', 'team_member'],
    userPath: [],
  },
  'manager.update': {
    roles: ['administrator'],
    key: 'manager-profile-update',
    tenantPath: ['organization', 'user', 'manager'],
    userPath: [],
  },
  'analyst.update': {
    roles: ['administrator', 'manager'],
    key: 'analyst-profile-update',
    tenantPath: ['organization', 'user', 'analyst'],
    userPath: [],
  },
  'team_member.delete': {
    roles: ['team-member', 'manager', 'analyst'],
...
const tenantRoles: string[] = ['administrator', 'team-member', 'manager', 'analyst'];
