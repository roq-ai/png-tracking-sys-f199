...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'team-member', 'manager', 'analyst'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Analysts', path: '/analysts', entity: 'analyst', service: AccessServiceEnum.PROJECT, icon: FiBarChart },
    { name: 'Guests', path: '/guests', entity: 'guest', service: AccessServiceEnum.PROJECT, icon: FiUserX },
    { name: 'Managers', path: '/managers', entity: 'manager', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    {
      name: 'Team Members',
      path: '/team-members',
      entity: 'team_member',
